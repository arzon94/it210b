...
var GoogleStrategy = require('passport-google-oauth').OAuth2Strategy; //This package is used for authentication with Google.  This will be used in part 2 of the NodeJS lab.
...
passport.use(new GoogleStrategy({
    clientID: "318393451024-mgdr32vnvmnd5kkpvif0mil082iuakf8.apps.googleusercontent.com",
    clientSecret: "woPzRi94RRdslui8fGmytFO4",
    callbackURL: "http://nodejs.dgclegg.it210.it.et.byu.edu/auth/google/return"
  },
...
THIS WILL BE USED IN PART 2 OF THE LAB, BUT YOU DON'T NEED TO MODIFY THIS FUNCTION.*/
app.get('/auth/google', 
   passport.authenticate('google', { scope: ['https://www.googleapis.com/auth/userinfo.profile', 'https://www.googleapis.com/auth/userinfo.email']}, { failureRedirect: '/login' }),
